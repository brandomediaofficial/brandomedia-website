      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-lg text-gray-600 mb-10 leading-relaxed">
            ...
            we&apos;ve grown into a team of passionate individuals, all united
            by a core set of values. These values are not just words, they are
          ...
          <ul className="space-y-6 text-gray-700">
            ...
            <li className="flex gap-3">
              ...
              <div>
                ...
                the curve through continuous learning and a finger on the pulse
                of the latest trends. This ensures your campaigns are not only
            ...
            <li className="flex gap-3">
              ...
              <div>
                ...
                beyond the ordinary. We craft digital marketing campaigns
                designed to make a lasting impression and propel your brand
                forward.
              </div>
            </li>
          </ul>
