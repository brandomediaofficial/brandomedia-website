    ...
    <section className="w-full flex flex-col md:flex-row">
      ...
      <div className="w-full md:w-1/2 bg-white p-8 md:p-16 flex flex-col justify-center">
        ...
        <p className="text-gray-700 leading-relaxed text-sm md:text-base">
          ...
          like constellations in the night sky. Brandomedia isn't just a name;
          it's a legacy—a force that shapes the digital universe. Join us on
          this cosmic journey, where imagination dances with technology, and
          every pixel tells a story. Together, we'll leave our mark, crafting
          impact that echoes through time. We are Brandomedia.
        </p>
      </div>
