        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-10 flex justify-center">
            <div className="border-2 border-blue-800 rounded p-2 px-4 inline-block">
              <h1 className="text-3xl md:text-4xl font-bold tracking-widest uppercase font-sans text-blue-900">
                Brando
              </h1>
              <p className="text-xs md:text-sm text-center tracking-[0.3em] uppercase -mt-1 text-blue-900">
                media
              </p>
            </div>
          </div>
          ...
          <div className="space-y-6 text-lg text-gray-700 leading-relaxed mb-12 text-left md:text-center">
            <p className="font-bold">
              Brandomedia is a creative agency based in Pondicherry India. We
              are a full-service studio offering strategy, design & video
            ...
            <p>
              ...
              years and offering the best video and digital marketing services
            ...
            <p>
              Brandomedia is a certified digital marketing company with more
              than 10 team members having great experience in providing digital
              marketing and video production services. If you are a business,
              and want to know how digital marketing can help your business to
              grow then we can offer you a digital marketing consulting at very
              affordable charges.
            </p>
          </div>
          ...
          <Link
            href="/contact"
            className="inline-block px-10 py-3 bg-white text-black border border-black font-bold rounded-full hover:bg-black hover:text-white transition-colors shadow-lg"
          >
            HIRE US !
          </Link>
        </div>
