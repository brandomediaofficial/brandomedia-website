        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-black leading-relaxed">
              We're looking for people who are results-oriented, who are always
              looking for ways to improve, and who are always willing to take on
              new challenges.
            </p>
          </div>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-black leading-relaxed">
              When you join Brandomedia, you'll be learning from the best in the
              business. Our team of experts is passionate about digital
              marketing, and we're always looking for ways to improve our skills
              and knowledge. We offer hands-on training and endless
