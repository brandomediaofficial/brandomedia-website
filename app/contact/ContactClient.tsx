      ...
      <section className="relative h-[400px] md:h-[500px] flex items-center justify-start overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl px-6 md:px-12 text-white">
          ...
          <p className="text-lg mb-8 leading-relaxed max-w-2xl text-gray-200">
            Get in touch with Brandomedia today and let&apos;s start a
            conversation about how our digital marketing expertise can elevate
            your business in Pondicherry. Whether you have questions, ideas, or
            are ready to embark on a digital journey, we&apos;re here to assist
            you. Reach out and discover how we can help you succeed online.
          </p>
          <button
      ...
      <section className="py-16 px-6 bg-white text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-700 text-lg leading-relaxed">
            Reach out to Brandomedia and start a conversation today. We&apos;re
            here to transform your digital presence and drive success for your
            Pondicherry-based business. Let&apos;s collaborate and make your
