...
export default function PrivacyPolicy() {
  return (
    <main className="pt-24 pb-16 min-h-screen bg-white text-gray-800">
      <div className="container mx-auto px-4 max-w-4xl">
        <h1 className="text-3xl md:text-4xl font-bold mb-6 text-black">
          Privacy Policy for Brandomedia
        </h1>
        <p className="mb-4">
          At www.brandomedia.in, accessible from one of our main priorities is
          the privacy of our visitors. This Privacy Policy document contains
          types of information that is collected and recorded by
          www.brandomedia.in and how we use it.
        </p>
        <p className="mb-4">
        ...
        <p className="mb-8">
          ...
          shared and/or collect in www.brandomedia.in. This policy is not
          applicable to any information collected offline or via channels other
          than this website.
        </p>

        <h2 className="text-2xl font-bold mb-4 text-black">Consent</h2>
        <p className="mb-8">
        ...
        <h2 className="text-2xl font-bold mb-4 text-black">Log Files</h2>
        <p className="mb-8">
          www.brandomedia.in follows a standard procedure of using log files.
        ...
        <p className="mb-4">
          ...
          advertising partners of www.brandomedia.in.
        </p>
        <p className="mb-4">
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on www.brandomedia.in, which are
        ...
        <p className="mb-8">
          Note that www.brandomedia.in has no access to or control over these
        ...
        <p className="mb-4">
          www.brandomedia.in&apos;s Privacy Policy does not apply to other
        ...
        <p className="mb-8">
          www.brandomedia.in does not knowingly collect any Personal
